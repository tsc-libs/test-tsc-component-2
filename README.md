...
1. For private GitHub NPM registry 
   1. Sign in to your npm account in your terminal with `npm login --scope=@tsc-libs --registry=https://npm.pkg.github.com`
   1. Run `npm publish` to publish your package
